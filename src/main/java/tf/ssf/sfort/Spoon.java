...
public class Spoon extends Item {
	...
	public ActionResult useOnBlock(ItemUsageContext context) {
		...
		//gunpowder place
		if (Config.gunpowder && p != null && p.getOffHandStack().getItem().equals(Items.GUNPOWDER) && world.getBlockState(pos.down()).isFullCube(world, pos.down()) && world.getBlockState(pos).isAir()) {
